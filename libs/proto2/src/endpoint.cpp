...
{
    impl().invalidatedConnection_ = impl().socketWrapper->invalidated.connect(
    ...
    impl().incomingRequestFrameConnection_ = impl().incomingRequestsManager->incomingRequestFrame.connect(
